...
using Otus.Project.DeliveryApi.Extensions;
using Otus.Project.DeliveryApi.Services;
using Otus.Project.DeliveryApi.Settings;
...
namespace Otus.Project.DeliveryApi
{
    public class Startup
    {
        ...
        private const string SubscriptionIdPrefix = "DeliveryService";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Otus.Project.DeliveryApi", Version = "v1" });
            ...
            services.AddScoped<PaymentRejectedConsumer>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Otus.Project.DeliveryApi v1"));
            }
