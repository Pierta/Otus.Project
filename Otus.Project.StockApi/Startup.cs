...
using Otus.Project.StockApi.Extensions;
using Otus.Project.StockApi.Services;
using Otus.Project.StockApi.Settings;
using Prometheus;
using System;
...
namespace Otus.Project.StockApi
{
    public class Startup
    {
        ...
        private const string SubscriptionIdPrefix = "StockService";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Otus.Project.StockApi", Version = "v1" });
            ...
            services.AddScoped<NoFreeSlotsConsumer>();
            services.AddScoped<DeliveryReleasedConsumer>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Otus.Project.StockApi v1"));
            }
